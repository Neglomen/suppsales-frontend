...
export default function AboutUsPage() {
  return (
    <div className="flex flex-col min-h-screen bg-slate-950 text-slate-100 overflow-x-hidden relative selection:bg-primary selection:text-white">
      ...
      <div className="absolute top-0 right-1/4 w-[500px] h-[500px] bg-primary/10 blur-[150px] rounded-full pointer-events-none z-0" />
      <div className="absolute bottom-0 left-1/4 w-[400px] h-[400px] bg-purple-600/10 blur-[150px] rounded-full pointer-events-none z-0" />
      ...
      <main className="flex-1 relative z-10 py-16">
        <div className="container mx-auto px-6 lg:px-12 max-w-5xl space-y-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="p-6 rounded-2xl glass border-white/5 bg-slate-900/10 backdrop-blur-sm">
              <span className="text-3xl sm:text-4xl font-extrabold text-slate-100 block">10M+</span>
              <span className="text-[10px] sm:text-xs text-slate-500 font-bold uppercase tracking-wider block mt-2">Zleconych Paczek</span>
            </div>
            <div className="p-6 rounded-2xl glass border-white/5 bg-slate-900/10 backdrop-blur-sm">
              <span className="text-3xl sm:text-4xl font-extrabold text-primary block">99.9%</span>
              <span className="text-[10px] sm:text-xs text-slate-500 font-bold uppercase tracking-wider block mt-2">Uptime serwera</span>
            </div>
            <div className="p-6 rounded-2xl glass border-white/5 bg-slate-900/10 backdrop-blur-sm">
              <span className="text-3xl sm:text-4xl font-extrabold text-slate-100 block">15 tys.</span>
              <span className="text-[10px] sm:text-xs text-slate-500 font-bold uppercase tracking-wider block mt-2">Zaoszczędzonych godzin</span>
            </div>
            <div className="p-6 rounded-2xl glass border-white/5 bg-slate-900/10 backdrop-blur-sm">
              <span className="text-3xl sm:text-4xl font-extrabold text-purple-400 block">&lt; 3s</span>
              <span className="text-[10px] sm:text-xs text-slate-500 font-bold uppercase tracking-wider block mt-2">Czas synchronizacji</span>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-12 gap-8 items-center pt-6">
            ...
            <div className="md:col-span-5 relative">
              ...
              <div className="glass border-white/10 bg-slate-900/40 backdrop-blur-xl p-6 rounded-2xl shadow-2xl space-y-4">
                <div className="h-10 w-10 rounded-xl bg-primary/10 border border-primary/20 flex items-center justify-center text-primary">
                  <TrendingUp className="h-5 w-5" />
                </div>
                <h4 className="text-sm font-bold text-slate-100 uppercase tracking-widest">Nasza Wizja:</h4>
          ...
          <div className="space-y-8 pt-6">
            <div className="text-center max-w-2xl mx-auto space-y-3">
              <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-100">Nasze Wartości</h2>
              <p className="text-slate-400 text-sm leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {VALUES.map((val, idx) => {
                const Icon = val.icon;
                return (
                  <Card key={idx} className="glass border-white/5 bg-slate-900/20 backdrop-blur-xl rounded-2xl overflow-hidden hover:border-primary/20 hover:shadow-lg transition-all duration-300 group">
                    <CardContent className="p-6 flex gap-4">
                      ...
                      <div className="space-y-2">
                        <h3 className="font-extrabold text-base text-slate-100">{val.title}</h3>
          ...
          <div className="rounded-3xl border border-white/5 bg-slate-900/30 backdrop-blur-md p-8 md:p-12 text-center space-y-6 relative overflow-hidden">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-slate-100">Zautomatyzuj swój e-commerce dzisiaj</h2>
